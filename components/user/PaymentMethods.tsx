  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-xl font-bold text-grey-pastel">Payment <span className="text-primary">Methods</span></h2>
          <p className="text-xs text-grey-medium">Manage your saved cards for one-click bookings.</p>
        </div>
        <Button 
                  ...
                  <div className="p-6 relative">
                    ...
                    <div className="flex items-start justify-between mb-8">
                      ...
                      <div className="text-right">
                        ...
                        <p className="text-white font-bold uppercase text-xs">{card.brand}</p>
                      </div>
                    </div>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex justify-between items-end">
                        <div>
                          ...
                          <p className="text-xs text-grey-pastel">{card.exp_month.toString().padStart(2, '0')}/{card.exp_year}</p>
                        </div>
      ...
      <div className="p-4 bg-primary/5 rounded-2xl border border-primary/10 flex items-start space-x-3">
        ...
        <div>
          <p className="text-xs font-bold text-primary">PCI Compliant Payments</p>
          <p className="text-[10px] text-grey-medium leading-relaxed">
            Your payment information is stored securely by Stripe. LuxRide never stores your full card details on our servers.
          </p>
        </div>
      </div>
    </div>
      ...
      <Card className="bg-dark-charcoal border-white/10 overflow-hidden">
        <div className="p-8 space-y-6">
          <div className="flex items-center space-x-4 mb-2">
            ...
            <div>
              <h3 className="text-white font-bold text-sm">Secure Card Collection</h3>
              <p className="text-[10px] text-grey-medium">Your data is encrypted and handled by Stripe.</p>
            </div>
          </div>
