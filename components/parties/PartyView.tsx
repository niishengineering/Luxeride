        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              {parties_section.map((bus) => (
                <PartyBusCard
                  ...
                  capacity={20} 
                  pricePerHour={250} 
                  amenities={bus.features ? bus.features.split(',').map(f => f.trim()) : []}
            ...
            <div className="lg:col-span-1 space-y-8">
              <GroupBookingCalculator />

              <div className="bg-dark-charcoal rounded-xl p-6 border border-dark-lighter">
                <h3 className="text-xl font-bold text-grey-pastel mb-4">
                  Party Packages
                </h3>
              ...
              <div className="bg-primary/10 rounded-xl p-6 border border-primary/30">
                ...
                <p className="text-sm text-grey-pastel mb-4">
                  Reserve your party bus at least 30 days in advance and get 10%
                  off your booking.
                </p>
