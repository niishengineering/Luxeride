      ...
      >
        ...
        <div className="relative h-64 overflow-hidden">
          ...
          <div className="absolute top-4 left-4 flex gap-2">
            <span className="px-2 py-1 rounded-md bg-black/40 backdrop-blur-md border border-white/10 text-xs font-medium text-white">
              {vehicle.title}
            </span>
          </div>
        ...
        <div className="p-6 flex flex-col flex-grow">
          ...
          <div className="pt-4 flex items-center justify-between mt-4">
           ...
           <button
              ...
              className="flex items-center space-x-2 px-3 py-2.5 rounded-full bg-white/5 hover:bg-primary text-white hover:text-black transition-all duration-300 font-medium text-sm group/btn"
            >
